...
- `HANDOFF_2026-06-28.md`: passagem de contexto antiga.
- `RETOMADA_2026-07-10.md`: registro de uma sessão específica.
- `RELATORIO_INSTAGRAM_ZION_CONVECTA.md`: análise comercial/de referência.

## Regra para novas sessões

Ao encerrar uma sessão, atualizar somente `CONTINUIDADE.md` com:
