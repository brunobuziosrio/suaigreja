    ...
    <div className="min-h-screen flex items-center justify-center p-6 text-center">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          O link pode estar incorreto ou o membro foi removido.
        </p>
      </div>
    </div>
  ),
...
function MemberCardPage() {
  ...
  const cardChurch = church as MemberCardChurch | null;
  const primary = church?.primary_color || "#0c2340";
  return (
    <div
      className="print-card-page min-h-screen flex flex-col items-center justify-center p-4 print:p-0 print:bg-white"
    ...
    >
      ...
      <div className="print-card-wrap w-full max-w-[720px]">
        <MemberCard
          ...
          church={{
            brand_title: cardChurch?.brand_title ?? null,
            card_logo_url: cardChurch?.card_logo_url ?? cardChurch?.brand_logo_url ?? null,
            card_logo_height_px: cardChurch?.card_logo_height_px ?? 72,
            primary_color: cardChurch?.primary_color ?? null,
            card_accent_color: cardChurch?.card_accent_color ?? null,
            card_footer_text: cardChurch?.card_footer_text ?? null,
            card_title_size_px: cardChurch?.card_title_size_px ?? null,
            card_footer_size_px: cardChurch?.card_footer_size_px ?? null,
