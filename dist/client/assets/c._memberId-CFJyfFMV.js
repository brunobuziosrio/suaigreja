import{x as e,j as a}from"./index-Ce0EG7uP.js";import{B as o}from"./button-Dqk_1C-x.js";import{M as n}from"./member-card-DPbeTSQz.js";import{P as m}from"./printer-BjwknTqz.js";import"./utils-DR15cbHK.js";import"./browser-DIPtNvuO.js";import"./createLucideIcon-q-X5jZDM.js";function x(){const{member:r,church:t}=e.useLoaderData(),i=t?.primary_color||"#0c2340";return a.jsxs("div",{className:"print-card-page min-h-screen flex flex-col items-center justify-center p-4 print:p-0 print:bg-white",style:{background:`linear-gradient(135deg, ${i}18, ${i}04)`},children:[a.jsx("style",{children:`
        @media print {
